...
class Photo_Post_Type_Admin {
	...
	public function add_custom_column( $columns ) {
		...
		$columns = array( 
			...
			'title' => __( 'Photo Name' , 'chills-photo-post-type' ),
			'thumbnail' => __( 'Thumbnail', 'chills-photo-post-type' ),
			'photo-id' =>__( 'Photo ID' , 'chills-photo-post-type' ),
			'photo-categories' =>__( 'Photo Categories' , 'chills-photo-post-type' ),
		);
		return $columns;
	}
	...
	public function display_thumbnail( $column ) {
		...
		global $post;
		$terms = get_terms( 'photo-category' );
		...
		switch ( $column ) {
			...
			case 'photo-categories' :
       			echo get_the_term_list($post->ID,'photo-category','',', ','');       
			break;
		}
	}
